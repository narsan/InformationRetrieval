In this phase, after data normalization, an inverted index has been created, which is a dictionary with words as a key and doc id's that have the specific words as values.
